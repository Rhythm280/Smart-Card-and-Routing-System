...
public class GraphService {
	...
	public Map<String, Double> getDistanceWeights() {
		return distanceWeights;
	}

	public Map<String, Double> getFareWeights() {
		return fareWeights;
	}

	public Map<Integer, Stop> getStopById() {
		return stopById;
	}

	public Integer idOf(String stopName) {
		return stopIdByName.get(stopName);
	}
}
